...
<template>
  <div v-if="page">
    <div class="relative">
      ...
      <ULandingHero v-motion-fade-visible :ui="{ wrapper: 'md:py-24' }" v-bind="page.hero" orientation="horizontal"
        :links="[
          {
            label: $t('my_CV'),
            to: `${page.contact.CV}#zoom=100`,
            target: '_blank',
            color: 'black',
    ...
    <UContainer class="">
      <ULandingLogos class="mb-20" v-motion-slide-bottom :title="page.technologies.title"
        :ui="{ title: 'text-3xl font-bold' }" align="center">
      ...
      <ULandingCTA id="contactMe" :title="page.cta.title" :description="page.cta.description" :card="false" :links="[
        {
          label: $t('contact_me'),
          to: `mailto:${page.contact.email}`,
          icon: 'i-material-symbols-mail',
